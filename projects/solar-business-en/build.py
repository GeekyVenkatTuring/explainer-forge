#!/usr/bin/env python3
"""Solar Panels as a Business — chapter-wise build orchestrator (Remotion).

Each chapter renders to its own MP4 and all chapters concat into the master.
Burned-in captions ON (the user asked for subtitles). Nova voice, 16:9 1080p30,
no vertical.
...
SLUG = "solar-panels-as-a-business"
